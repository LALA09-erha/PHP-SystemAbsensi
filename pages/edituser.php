...
if(isset($_POST['submit'])){
    ...
    $sql2 = "UPDATE users SET role = '$role' WHERE idUser = '$iduser'";
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">EDIT USER  </h2>
				</div>
			</div>
			<div class="row justify-content-center">
				...
				<form action="#" method="POST" class="login-form">
                    <div class="form-group">
                            ...
                            <input type="text" name="role" class="form-control rounded-left" placeholder="Role" value="<?php echo $row['role']?>" required>
                        </div>
                    <?php
                    ...
                    <div class="row justify-content-center">
                        <span>Don't want to edit ?  <a href="user.php" class="text-center">Come Back</a></span>
                    </div>
	          </form>
	        </div>
				</div>
