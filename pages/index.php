                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered text-center" id="dataTable" width="100%"
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT * FROM mahasiswa where mahasiswa.kodeUser=" . $_SESSION['id'];
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<td>";
                                                echo "<a href='editstudent.php?NIM=" . $row['NIM'] . "' class='btn btn-primary m-1'>Edit</a>";
                                                echo "<a href='../proses/delete.php?NIM=" . $row['NIM'] . "'  class='btn btn-danger' onclick='return confirm(\"Really delete?\")'>Delate</a>";
                                                echo "</td>";
                                                echo "</tr>";
                                            }
                                        } else {
