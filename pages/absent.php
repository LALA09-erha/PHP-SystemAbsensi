        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <div class="d-none d-sm-inline-block div-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        <div class="input-group">
                            <button class="btn btn-primary"
                                onclick=<?php echo 'CopyMe("localhost/paw/uts/attendance.php?id=' . $data . '")' ?>>
                                Copy Link
                            </button>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow d-sm-none">
                            <a class="nav-link dropdown-toggle" href="#" id="searchDropdown" role="button"
                                ...
                                <i class="fas fa fa-link fa-fw"></i>
                            </a>
                            <!-- Dropdown - Messages -->
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered text-center" id="dataTable" width="100%"
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT * FROM absen,mahasiswa,matakuliah,users WHERE absen.kodeUser = users.idUser AND absen.kodeSiswa = mahasiswa.NIM AND absen.kodeMatkul = matakuliah.idMatkul AND users.idUser =" . $_SESSION['id'];
                                        $query = mysqli_query($conn, $sql);
                                        if (mysqli_num_rows($query) > 0) {
                                            while ($row = mysqli_fetch_assoc($query)) {
                                                echo "<tr>";
                                                if (preg_match("/-/", $row['kodeSiswa'])) {
                                                    $posisi = strpos($row['kodeSiswa'], '-');
                                                    $NIM = substr($row['kodeSiswa'], $posisi + 1);
                                                    echo "<td>" . $NIM . "</td>";
                                                } else {
                                                    echo "<td>" . $row['kodeSiswa'] . "</td>";
                                                    // echo "<td>".$row['NIM']."</td>";
                                                }
                                                ...
                                                echo "<td>";
                                                echo "<a href='../proses/delete.php?kode=" . $row['idAbsen'] . "'  class='btn btn-danger' onclick='return confirm(\"Really delete?\")'>Delate</a>";
                                                echo "</td>";
                                                echo "</tr>";
                                            }
                                        } else {
